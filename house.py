...
# 要抓取頁面的Url
urls = [
    "https://rent.591.com.tw/list?section=3,4,11,5,7&kind=2&price=9000$_15000$&other=newPost&region=1&sort=posttime_desc&notice=all_sex,not_cover",
    "https://rent.591.com.tw/list?kind=3&price=9000$_15000$&other=newPost&sort=posttime_desc&region=1&section=5,3,7,4,11&notice=all_sex,not_cover"
]
